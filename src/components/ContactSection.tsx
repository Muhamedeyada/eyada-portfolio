  ...
  const contactInfo = [
    {
      ...
      title: "Email",
      content: "mohamed.ayada.ma@gmail.com",
      link: "mailto:mohamed.ayada.ma@gmail.com",
    },
    {
      icon: <Phone className="h-5 w-5" />,
      title: "Phone",
      content: "+201555389865",
  ...
  const socialLinks = [
    {
      ...
      href: "https://github.com/Muhamedeyada",
    },
    {
      name: "linkedin",
      icon: <Linkedin className="w-5 h-5" />,
      href: "https://www.linkedin.com/in/mohamed-eyada/",
    },
  ];
      ...
      <div className="container mx-auto max-w-6xl">
        <div className="flex flex-col items-center text-center mb-10 md:mb-16">
          ...
          <p className="text-muted-foreground max-w-2xl mt-6 text-sm sm:text-base text-justify md:text-center">
            Have a question or want to work together? Reach out to me using the
            form below.
          </p>
        </div>
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            >
              {contactInfo.map((item, index) => (
                <ContactInfoCard key={index} {...item} isMobile={isMobile} />
              ))}
            </div>
