...
const HeroSection = () => {
  ...
  return (
    <section
      id="home"
      className="min-h-screen flex flex-col justify-center relative pt-12 section"
    >
        ...
        <div className="md:col-span-3 space-y-4">
          <div className="flex flex-col">
            ...
            <h1 className="text-2xl md:text-4xl lg:text-5xl font-bold leading-tight">
              <span className="text-gradient">Mohamed Eyada</span>
              <br />
              <div className="h-[1.2em] mt-1">
                <span className="relative inline-flex">{text}</span>
                <span
                  className="animate-blink inline-block bg-primary ml-1"
                  style={{ width: "2px", height: "80%", marginBottom: "-4px" }}
                ></span>
              </div>
            </h1>
            <div className="mt-4">
